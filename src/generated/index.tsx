...
export type ListReposQuery = (
  ...
  & { rateLimit?: Maybe<(
    { __typename?: 'RateLimit' }
    & Pick<RateLimit, 'cost' | 'remaining' | 'resetAt'>
  )>, search: (
    { __typename?: 'SearchResultItemConnection' }
 ...
 * });
 */
export function useListReposQuery(baseOptions: Apollo.QueryHookOptions<ListReposQuery, ListReposQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListReposQuery, ListReposQueryVariables>(ListReposDocument, options);
      }
export function useListReposLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListReposQuery, ListReposQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListReposQuery, ListReposQueryVariables>(ListReposDocument, options);
        }
